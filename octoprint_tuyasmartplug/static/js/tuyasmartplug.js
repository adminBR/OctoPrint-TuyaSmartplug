...
$(function () {
    function tuyasmartplugViewModel(parameters) {
        ...
        self.removePlug = function (row) {
            self.settings.settings.plugins.tuyasmartplug.arrSmartplugs.remove(
                row
            );
        };
                    ...
                    default:
                        new PNotify({
                            ...
                            text:
                                ...
                                " for " +
                                plug.ip() +
                                ". Double check IP Address\\Device ID\\Local Key in Octoprint-TuyaSmartplug Settings.",
                            type: "error",
                            hide: true,
                        });
        ...
        self.checkStatuses = function () {
            ...
            if (self.settings.settings.plugins.tuyasmartplug.pollingEnabled()) {
                setTimeout(function () {
                    ...
                    self.settings.settings.plugins.tuyasmartplug.pollingInterval(),
                    10
                ) * 60000);
            }
        };
